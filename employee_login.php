        ...
        <h1 style="text-align:center">Login Here</h1>
		    ...
		    {    
		        ...
		        {  
		            ...
		            $sql= "SELECT username,password FROM emp_login WHERE username='$user' AND password='$pass' AND phase='$grp';";
		            ...
		            {  
		                ...
		                if($user == $dbusername && $pass == $dbpassword)  
		                {
							...
							{
								//echo"rajat";
								$sql="UPDATE emp_profile SET attendence='$count'+1,date='$currdate', salary='$salary' ,efforts='$hour' WHERE username='$user';";
								$query=mysqli_query($con,$sql);
								if($query)
								{
									...
									echo"<script>setTimeout(\"location.href='employee_profile.php'\",0);</script> ";
